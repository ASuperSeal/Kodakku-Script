...
namespace MyScriptNamespace
{
    ...
    public class EdenUltimate 
    {
        ...
        """
        海豹修改，使用欧服打法，参考以下raidplan，以k佬1.0.0.0为原版进行修改
        P1: 修改了四线优先级，转轮召修改完毕。非常感谢@Ruru的帮助。 踩塔修改完了  使用https://raidplan.io/plan/V0swEBYmpTP22HnK
        P2: 修改了光之暴走的优先级，现在光爆的塔是上下对穿左上右上对穿 使用https://raidplan.io/plan/FG4cE9SQY4h5ryOT
        P3: 修正了灯的指路以适配欧服站位。
